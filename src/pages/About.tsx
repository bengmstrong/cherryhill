        ...
        <div className="mx-auto max-w-[680px] px-6">
          <section className="mb-16">
            <p className="prose-estate mb-6 first-letter:font-serif first-letter:text-7xl first-letter:float-left first-letter:leading-[0.85] first-letter:mr-3 first-letter:mt-1 first-letter:text-gold">
              Cherry Hill is now the home of Ben and Julia Strong, two leaders in the
            ...
            <p className="prose-estate mb-6">
              ...
              Their work has shaped environmental programs around the world, and their stewardship of
              Cherry Hill reflects that same sense of purpose locally in Roanoke — preserving a place with a
              deep past while making room for new ideas, gatherings, and creative life.
            </p>
            <p className="prose-estate">
              Under their care, Cherry Hill is being renewed as not only their home but as ahome for history,
